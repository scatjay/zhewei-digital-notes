...
0. **🔴 楊老師交代的下一階段任務，觸發時機16:25更正為「哲維老師的全部第一版落地之後」**
   （最新原話：「哲維老師的全部第一版落地之後，再全部重頭到尾再盤點一次。」——這句話**取代**
   舊版的「第六場處理完之後」觸發條件，範圍縮小到只看張哲維老師自己主講的場次是否都有第一版，
   不必再等王道維老師自己的第七場/圓桌二）——具體要做：
   - **觸發條件**：張哲維老師主講的場次（第一/二/四/五/六場）**全部**都要有「第一版」落地——
     目前現況（16:25）：第一/二/四/五場都已splice+科普轉譯定稿上站；**第六場逐字稿已splice上站，
     但科普轉譯草稿的紅隊複核還在跑，must_fix還沒套用定稿**——嚴格說第六場的「第一版」要等
     這個複核套用完才算真的落地，這是啟動這個跨場次盤點任務前最後一塊要完成的拼圖。
   - 全盤盤點張哲維老師講過的所有單元（第一/二/四/五/六場）——內容、教學脈絡、彼此的銜接
     關係整理成一份總覽，**從頭到尾重新盤點一次**（楊老師16:25用詞）。
   - **扣合對準王道維老師的討論**——王道維老師已經在第六場尾聲現身、當場提出討論（見第六場
     現場問答節），且第七場（王道維老師主講）、圓桌二（引言人之一）也都有他的材料——第七場
     已於16:23完整splice上站（無投影片，純逐字稿+獨立第二輪校對），圓桌二錄音楊老師正在跟
     主辦窗口確認中（16:18告知），materials到齊可以再補充對照，但這不是這個任務啟動的必要
     前提條件（觸發只看張哲維老師自己場次的第一版）。
   ...
   - 這件事優先權在第六場科普轉譯紅隊複核+套用must_fix完成之後，不要提前開始。
