...
| **第七場**（王道維） | ✅ 兩輪校對完成(12節)，無投影片純逐字稿整理 | ✅ 已上站(commit f68a73a，單層pill導覽article框架) | ⏳ 待enqueue | 第二輪抓到第一輪自編「講者任教成大」的腦補理由，已更正；楊老師現場核對確認王道維老師實際任教清大物理系；⚠找不到投影片檔案，之後若出現要回頭補對照；**科普轉譯還沒排進度**（這場本身是演講+Q&A、內容已經偏科普口吻，要不要照第四/五/六場一樣多做一層科普轉譯章節，還沒問過楊老師，先不要自己決定跳過） |
