...
| **第六場** | ✅ 兩輪完整校對+去口語化（93頁,71頁有內容）+現場問答17分鐘5段+科普轉譯6節 | ✅ **全部已上站**(commit 35e5dff，逐字稿+科普轉譯皆完成) | ⏳ 待enqueue | 第二輪抓到第一輪P74編造內容錯誤(CSV截圖誤判成總督府檔案)；科普轉譯紅隊複核抓到p58主權AI段落只列標題未引用，楊老師16:30裁示比照p56補上完整原話；**第六場「第一版」至此完整落地** |
| **第七場**（王道維） | ✅ 兩輪校對完成(12節)，無投影片純逐字稿整理 | ✅ 已上站(commit f68a73a，單層pill導覽article框架) | ⏳ 待enqueue | 第二輪抓到第一輪自編「講者任教成大」的腦補理由，已更正；楊老師現場核對確認王道維老師實際任教清大物理系；⚠找不到投影片檔案，之後若出現要回頭補對照；**楊老師16:26確認要做科普轉譯**，草稿已派工中（無投影片，依round2_final.json的12節內容自訂結構） |
