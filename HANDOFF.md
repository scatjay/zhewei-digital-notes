...
| 第六場 | ⏳ 錄音已下載+轉錄完成(2867 segments/87.6分鐘)，第一輪頁碼對齊+去口語化進行中 | ✅ stub+3則現場筆記 | — | 投影片`slides-session6.pdf`已在repo，現場筆記見第3節末 |
| **第七場**（王道維） | ⏳ 錄音已下載+轉錄完成(1232 segments/36.2分鐘)，第一輪校對進行中 | ✅ stub | — | ⚠**找不到投影片檔案**（Drive遍尋不到，可能沒上傳或本來就沒有投影片），第一輪只能做純逐字稿整理，不做頁碼對齊；之後若投影片出現要回頭補對照 |
| 圓桌二 | ❌ 錄音尚未上傳 | ✅ stub | — | — |
